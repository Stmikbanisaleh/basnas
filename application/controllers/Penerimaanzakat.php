...
class Penerimaanzakat extends CI_Controller
{

	function __construct()
	{
		parent::__construct();
		$this->load->model('model_penerimaanzakat');
	...
	public function index()
	{
		if ($this->session->userdata('username') != null && $this->session->userdata('nama') != null) {
			$myjabatan = $this->model_penerimaanzakat->viewOrdering('users', 'ID', 'asc')->result_array();
			$data = array(
				'page_content' 	=> '/penerimaanzakat/view',
				'ribbon' 		=> '<li class="active">Dashboard</li><li>Penerimaan Zakat</li>',
				'page_name' 	=> 'Penerimaan Zakat',
				'js' 			=> 'js_file',
				'myjabatan'		=> $myjabatan,
			);
