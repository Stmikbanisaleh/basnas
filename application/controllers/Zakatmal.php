...
class Zakatmal extends CI_Controller
{
	...
	public function downloadsample()
	{
		...
		$id_zakatmal = $this->model_zakatmal->joinzakatmal()->result_array();
		$data = $id_zakatmal;
		$no = 1;
		$row = 2;
		if (count($data) > 0) {
			if ($data) {
				...
				$objPHPExcel->setActiveSheetIndex(0)->setCellValue('G1', 'Petugas');
				$objPHPExcel->setActiveSheetIndex(0)->setCellValue('H1', 'Jenis Zakat');
				...
				$objPHPExcel->setActiveSheetIndex(0)->setCellValue('G2', '123456');
				$objPHPExcel->setActiveSheetIndex(0)->setCellValue('H2', '3');

				$objPHPExcel->setActiveSheetIndex(0)->setCellValue('A3', '17');
				$objPHPExcel->setActiveSheetIndex(0)->setCellValue('B3', 'Angsuran');
				...
				$objPHPExcel->setActiveSheetIndex(0)->setCellValue('G3', '123456');
				$objPHPExcel->setActiveSheetIndex(0)->setCellValue('H3', '4');
				...
				$objPHPExcel->setActiveSheetIndex(0)->setCellValue('M2', 'Tunai');
				$objPHPExcel->setActiveSheetIndex(0)->setCellValue('M3', 'Angsuran');
				...
				$objPHPExcel->setActiveSheetIndex(0)->setCellValue('T1', 'Petugas');
				$objPHPExcel->setActiveSheetIndex(0)->setCellValue('U1', 'Jenis Zakat');
				$objPHPExcel->setActiveSheetIndex(0)->setCellValue('V1', 'Nama Jenis Zakat');
				foreach ($data as $dataExcel) {
					...
					$objPHPExcel->getActiveSheet(0)->setCellValueExplicit('T' . $row, $petugas, PHPExcel_Cell_DataType::TYPE_STRING);
					...
					$objPHPExcel->getActiveSheet(0)->setCellValueExplicit('U' . $row, $jenis_zakat, PHPExcel_Cell_DataType::TYPE_STRING);
					...
					$objPHPExcel->getActiveSheet(0)->setCellValueExplicit('V' . $row, $nama_jenis_zakat, PHPExcel_Cell_DataType::TYPE_STRING);
