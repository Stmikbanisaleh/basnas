...
class Pp_zakat_kabupaten_kota extends CI_Controller
{
    ...
    public function laporan()
	{
        if ($this->session->userdata('username') != null && $this->session->userdata('nama') != null) {
			...
			$myzakatmaal = $this->model_pp_zakat_kabupaten_kota->view_sum_zakat_maal($post_tgl_awal, $post_tgl_akhir)->result_array();
			$myzakatfitrah = $this->model_pp_zakat_kabupaten_kota->view_sum_zakat_fitrah($post_tgl_awal, $post_tgl_akhir)->result_array();
			$myinfaq = $this->model_pp_zakat_kabupaten_kota->view_sum_infaq($post_tgl_awal, $post_tgl_akhir)->result_array();
			$mymuzaki = $this->model_pp_zakat_kabupaten_kota->view_sum_data_muzaki($post_tgl_awal, $post_tgl_akhir)->result_array();
			$mybidang = $this->model_pp_zakat_kabupaten_kota->view_sum_bidang($post_tgl_awal, $post_tgl_akhir)->result_array();
			$myasnaf = $this->model_pp_zakat_kabupaten_kota->view_sum_asnaf($post_tgl_awal, $post_tgl_akhir)->result_array();
