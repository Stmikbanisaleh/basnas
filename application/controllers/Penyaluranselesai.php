...
class Penyaluranselesai extends CI_Controller
{

	function __construct()
	{
		parent::__construct();
		$this->load->model('model_penyaluranselesai');
	...
	public function index()
	{
		if ($this->session->userdata('username') != null && $this->session->userdata('nama') != null) {
			$mypenyaluran = $this->model_penyaluranselesai->viewWhereOrderingpenyalur('master_penyaluran', 'id', 'asc')->result_array();
			$data = array(
				'page_content' 	=> '/penyaluranselesai/view',
	...
	public function tampil_byid()
	{
		if ($this->session->userdata('username') != null && $this->session->userdata('nama') != null) {
			...
			$my_data = $this->model_penyaluranselesai->view_where('master_penyaluran', $data)->result();
	...
	public function update()
	{
		if ($this->session->userdata('username') != null && $this->session->userdata('nama') != null) {
			...
			$result = $this->model_penyaluranselesai->update($data_id, $data, 'master_penyaluran');
			echo json_decode($result);
		} else {
			$this->load->view('page/login'); //Memanggil function render_view
		}
