...
class Laporan_laporanrencanadanrealisasipenggalanganmuzakkidanpenerimamanfaat extends CI_Controller
{
	...
	public function index()
	{
		if ($this->session->userdata('username') != null && $this->session->userdata('nama') != null) {
			$data = array(
				'page_content' 	=> '/laporanrencanadanrealisasipenggalanganmuzakkidanpenerimamanfaat/view',
				'ribbon' 		=> '<li class="active">Dashboard</li><li>Laporan Penyaluran Rencana dan Realisasi Penggalangan Muzakki dan Penerima Manfaat </li>',
				'page_name' 	=> 'Laporan Penyaluran Rencana dan Realisasi Penggalangan Muzakki dan Penerima Manfaat ',
				'js' 			=> 'js_file',
			);
	...
	public function laporanrencanadanrealisasipenggalanganmuzakkidanpenerimamanfaat()
	{
