...
class Rr_penerimaan_dan_penggunaan_hak_amil extends CI_Controller
{
    ...
    public function laporan()
	{
        if ($this->session->userdata('username') != null && $this->session->userdata('nama') != null) {
			...
			$myzakat = $this->model_rr_penerimaan_dan_penggunaan_hak_amil->view_zakat($post_tgl_awal, $post_tgl_akhir)->result_array();
			$myinfaq = $this->model_rr_penerimaan_dan_penggunaan_hak_amil->view_infaq($post_tgl_awal, $post_tgl_akhir)->result_array();
			$mytotal_penerimaan = $this->model_rr_penerimaan_dan_penggunaan_hak_amil->view_total_penerimaan($post_tgl_awal, $post_tgl_akhir)->result_array();
