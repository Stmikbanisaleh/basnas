					...
					<div class="col-xs-12">
						...
						<form class="form-horizontal" role="form" enctype="multipart/form-data" id="formImport">
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									<a href="<?php echo base_url() . 'penyaluranprogram/downloadsample' ?>" class="col-sm-3" for="form-field-1"> Download Sample Format</a>
								</div>
							</div>
					</div>
				</div>
	...
	if ($("#formImport").length > 0) {
		$("#formImport").validate({
			...
			submitHandler: function(form) {
				...
				$.ajax({
					type: "POST",
					url: "<?php echo base_url('penyaluranprogram/import') ?>",
					data: formdata,
					processData: false,
					contentType: false,
					cache: false,
