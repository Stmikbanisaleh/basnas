					...
					<div class="row">
						<div class="col-xs-12">
							...
							<div class="form-group">
								...
								<div class="col-sm-6">
									<input type="text" id="nama" name="nama" placeholder="Nama Pekerjaan" class="form-control" />
								</div>
							</div>
						</div>
					</div>
						...
						<div class="col-xs-12">
							...
							<div class="form-group">
								...
								<div class="col-sm-6">
									...
									<input type="text" id="e_nama" name="e_nama" placeholder="Nama Pekerjaan" class="form-control" />
								</div>
							</div>
						</div>
					</div>
	...
	if ($("#formTambah").length > 0) {
		$("#formTambah").validate({
			...
			submitHandler: function(form) {
				...
				$.ajax({
					url: "<?php echo base_url('pekerjaan/simpan') ?>",
					type: "POST",
					...
					success: function(response) {
						...
						if (response == true) {
							...
							swalIdDouble('Nama Pekerjaan Sudah digunakan!');
						} else {
							swalInputFailed();
						}
						// setTimeout(function(){
				...
				$.ajax({
					...
					success: function(response) {
						...
						if (response == true) {
							...
							swalIdDouble('Nama jenis Pekerjaan Sudah digunakan!');
						} else {
							swalEditFailed();
						}
					}
...
<script type="text/javascript">
	...
	function show_data() {
		$.ajax({
			type: 'POST',
			url: '<?php echo site_url('pekerjaan/tampil') ?>',
			async: true,
			dataType: 'json',
	...
	$('#show_data').on('click', '.item_edit', function() {
		...
		$.ajax({
			type: "POST",
			url: "<?php echo base_url('pekerjaan/tampil_byid') ?>",
			async: true,
			dataType: "JSON",
			data: {
				id: id,
