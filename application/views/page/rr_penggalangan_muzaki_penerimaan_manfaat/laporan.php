...
header("content-disposition:attactment;filename=Laporan rencana dan realisasi penggalangan muzakki dan penerimaan manfaat ".$post_tgl_awal." sd ".$post_tgl_akhir.".xls");
