...
<body>
    <table class="style2" cellspacing="3">
        ...
        <tr>
            ...
            <td colspan="5">
                <?php echo ": " . ucwords(terbilang($my_data[0]->jumlah_dana_disetujui)) . " Rupiah"; ?>
            </td>
        </tr>
        <tr>
            <td colspan="2">
        ...
        <tr>
            <td colspan="4"></td>
            <td align="right" colspan="3" style="text-align: left;">Penerima</td>
        </tr>
        <tr>
            <td></td>
        </tr>
        ...
        <tr>
            <td colspan="4"></td>
            <td align="right" colspan="3" style="text-align: left;"><?php echo strtoupper($my_data[0]->mustahik) ?>
            </td>
        </tr>
    </table>
</body>
