...
<div id="my-modal" class="modal fade" tabindex="-1">
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
				<h3 class="smaller lighter blue no-margin">Form Input Data Zakat Maal</h3>
			</div>
			<div class="modal-body">
				<div class="row">
					<div class="col-xs-12">
						...
						<form class="form-horizontal" enctype="multipart/form-data" role="form" id="formTambah">
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									<select class="form-control" name="norek" id="norek">
										<option value="0">-- No. Rekening --</option>
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									<input type="number" id="total" required name="total" placeholder="total penerimaan" class="form-control" />
								</div>
							</div>
					...
					<div class="col-xs-12">
						...
						<form class="form-horizontal" enctype="multipart/form-data" role="form" id="formEdit">
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									<input type="text" id="e_deskripsi" required name="e_deskripsi" placeholder="Deskripsi" class="form-control" />
								</div>
							</div>
					</div>
				</div>
