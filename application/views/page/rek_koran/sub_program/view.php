                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <select class="form-control" name="id_master_program" id="id_master_program">
                                        <option value=>--Pilih Program--</option>
                                        <?php foreach ($prog as $value) { ?>
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-xs-12">
                            ...
                            <div class="form-group">
                                <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Nama Sub Program </label>
                                <div class="col-sm-6">
                            ...
                            <div class="form-group">
                                <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Program </label>
                                <div class="col-sm-6">
                                    <select class="form-control" name="e_id_master_program" id="e_id_master_program">
                                        <option value=>--Pilih Program--</option>
                                        <?php foreach ($prog as $value) { ?>
                                            <option value=<?= $value['id'] ?>><?= $value['nama'] ?></option>
                                        <?php } ?>
    ...
    if ($("#formTambah").length > 0) {
        $("#formTambah").validate({
            ...
            messages: {
                ...
                id: {
                    required: "Kode Sub Program harus diisi!"
                    // ,maxlength: "Your last name maxlength should be 50 characters long."
                },
                id_master_program: {
                    required: "Nama Sub Program harus diisi!"
            ...
            submitHandler: function(form) {
                ...
                $.ajax({
                    url: "<?php echo base_url('sub_program/simpan') ?>",
                    type: "POST",
                    ...
                    success: function(response) {
                        ...
                        if (response == true) {
                            ...
                            swalIdDouble('Nama Sub Program Sudah digunakan!');
                        } else {
                            swalInputFailed();
                        }
                        // setTimeout(function(){
    ...
    if ($("#formEdit").length > 0) {
        $("#formEdit").validate({
            ...
            submitHandler: function(form) {
                ...
                $.ajax({
                    url: "<?php echo base_url('sub_program/update') ?>",
                    type: "POST",
...
<script type="text/javascript">
    ...
    function show_data() {
        $.ajax({
            type: 'POST',
            url: '<?php echo site_url('sub_program/tampil') ?>',
            async: true,
            dataType: 'json',
    ...
    $('#show_data').on('click', '.item_edit', function() {
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo base_url('sub_program/tampil_byid') ?>",
            async: true,
            dataType: "JSON",
            data: {
                id: id,
    ...
    $('#show_data').on('click', '.item_hapus', function() {
        ...
        Swal.fire({
            ...
            if (result.value) {
                $.ajax({
                    type: "POST",
                    url: "<?php echo base_url('sub_program/delete') ?>",
                    async: true,
                    dataType: "JSON",
                    data: {
                        id: id,
