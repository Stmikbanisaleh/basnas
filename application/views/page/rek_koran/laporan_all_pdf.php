...
<body>
    <div class="">
		<div>
			...
			<hr>
            <center><font size="2"><b>REKAPITULASI REKENING KORAN<b><font></center>
		</div>
        <br>
		<div class="font_size">
            <table border='1'>
                <tr>
                    ...
                    <td style="width: 90px; text-align: center">NPWPZ</td>
                    <td style="width: 110px; text-align: center">Nama</td>
                    <td style="width: 130px; text-align: center">Alamat</td>
                    <td style="width: 60px; text-align: center">Provinsi</td>
                    <td style="width: 60px; text-align: center">Tanggal</td>
                    <td style="width: 60px; text-align: center">Transaksi</td>
                    <td style="width: 100px; text-align: center">Jumlah</td>
                </tr>
                <?php
                    $no = 1;
